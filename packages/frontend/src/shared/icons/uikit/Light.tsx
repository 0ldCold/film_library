...
import { IconProps } from 'src/shared/icons/uikit/types';

const Light: FC<IconProps> = ({ size, color = 'white' }) => {
  return (
    <svg fill={color} width={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g id="Light">
        <g>
